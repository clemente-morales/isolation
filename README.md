...
## Main functions (`game_agent.py`):

- `CustomPlayer.minimax()`: Minimax search
- `CustomPlayer.alphabeta()`: Minimax search with alpha-beta pruning
- `CustomPlayer.get_move()`: Fixed-depth and iterative deepening search
- `custom_score()`: Position evaluation heuristic
